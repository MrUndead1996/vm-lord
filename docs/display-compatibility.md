...
- The first desktop provisioning and DKMS build need guest access to the
  distribution's own package repositories. After a successful installation, display frames and
